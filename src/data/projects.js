const projects = [
    {
        id: 1,
        title: "Textbook Manager System",
        date: "Fall 2021",
        team: "James Bell, Negin Jahanbakhsh, Fidel Paredes, Hanadi Jusufovic",
        report: "textbook-manager-system.pdf",
        github: "https://github.com/jamesbell00/textbook-manager-system",
        description: `The textbook manager system is designed to manage textbooks for courses as well as the student evaluations for these books. 
                    Teachers may select one or more textbooks for classes.
                    Various courses may have the same textbooks. 
                    Students are given the option to evaluate these books.`,
        stack: `UML, MySQL, Java, Java Swing`
    }, 
    {
        id: 2,
        ...
        description: `Designed using Java Swing, this game consists of a dynamic structure with multiple levels of increasing difficulty. 
                    Includes a timer, high score, and a complex algorithm which places words on the table and matches it with other words if letters are shared.`, 
